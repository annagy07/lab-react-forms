...
function App() {
  ...
  const [studentsDataSet, setStudentsDataSet] = useState(studentsData);
  ...
  const addNewStudent = (newStudent) => {
    ...
    const updatedStudentsDataSet = [...studentsDataSet, newStudent];

    setStudents(updatedStudents);
    setStudentsDataSet(updatedStudentsDataSet);
  };
